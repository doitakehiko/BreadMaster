...
namespace BreadMaster
{
    public partial class FormF : Form
    {
        ...
        private void FormF_Load(object sender, EventArgs e)
        {
            ...
            string sql = "SELECT * FROM filling_master";
            try
            {
        ...
        private void buttonUpd_Click(object sender, EventArgs e)
        {
            ...
            {
                string sqlUpd = "UPDATE filling_master SET filling_name = :name WHERE id = :id";
                try
                {
                    using (OracleConnection connection = new OracleConnection(connectionString))
                    {
        ...
        private void buttonIns_Click(object sender, EventArgs e)
        {
            ...
            string sqlIns = "INSERT INTO filling_master (filling_name) VALUES (:name)";
            string sql2 = "SELECT filling_master_seq.CURRVAL as id FROM dual";
        ...
        private void buttonDel_Click(object sender, EventArgs e)
        {
            ...
            string sqlDel = "DELETE FROM filling_master WHERE id = :id";
            try
            {
                using (OracleConnection connection = new OracleConnection(connectionString))
                {
