...
{
    public partial class FormSauce : Form
    {
        ...
        private void FormSauce_Load(object sender, EventArgs e)
        {
            dataGridView1.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
            dataGridView1.MultiSelect = false;
            dataGridView1.ReadOnly = true;
            string sql = "SELECT * FROM sauce_master";
            try
            {
        ...
        private void buttonDel_Click(object sender, EventArgs e)
        {
            ...
            string sqlDel = "DELETE FROM sauce_master WHERE id = :id";
            try
            {
                using (OracleConnection connection = new OracleConnection(connectionString))
                {
        ...
        private void buttonUpd_Click(object sender, EventArgs e)
        {
            ...
            {
                string sqlUpd = "UPDATE sauce_master SET sauce_name = :name WHERE id = :id";
                try
                {
                    using (OracleConnection connection = new OracleConnection(connectionString))
                    {
